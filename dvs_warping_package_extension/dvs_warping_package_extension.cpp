...
static PyMethodDef dvs_warping_package_extension_methods[] = {
...
static struct PyModuleDef dvs_warping_package_extension_definition = {
    PyModuleDef_HEAD_INIT,
    "dvs_warping_package_extension",
    "dvs_warping_package_extension speeds up some sessiontools operations",
    -1,
    dvs_warping_package_extension_methods};
PyMODINIT_FUNC PyInit_dvs_warping_package_extension() {
    auto module = PyModule_Create(&dvs_warping_package_extension_definition);
    import_array();
    return module;
}